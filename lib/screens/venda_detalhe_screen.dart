  ...
  void initState() {
    ...
    Services.getVend(_pedido).then((usersFromServer) {
      setState(() {
        ...
        CondPagtoCadastro =
            usersFromServer.infoLiberacao.infoCredito.condicoesPagto;
        ...
        es_fantasia = usersFromServer.esFantasia;
        ...
        situacao_ped = usersFromServer.situacaoPed;
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          compras_detalhe_widget(
                            ...
                            texto2: 'R${formatCurrency.format(TotCrVencidos)}',
                          ),
                          Divider(),
                          compras_detalhe_widget(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          compras_detalhe_widget(
                            ...
                            texto2: 'R${formatCurrency.format(LimiteCredito)}',
                          ),
                          Divider(),
                          compras_detalhe_widget(
                          ...
                          compras_detalhe_widget(
                            ...
                            texto2: 'R${formatCurrency.format(faturamentomin)}',
                          ),
                          Divider(),
                          compras_detalhe_widget(
